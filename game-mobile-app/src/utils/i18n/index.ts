...
const viTranslations = {
  ...
  '3_star': '3 sao',
  '1_2_star': '1-2 sao',
  comment_added: 'Bình luận đã được thêm thành công',
  comment_deleted: 'Bình luận đã được xóa thành công',
  comment_error: 'Có lỗi khi thêm bình luận',
  delete_comment_error: 'Có lỗi khi xóa bình luận',
  login_required: 'Yêu cầu đăng nhập',
  login_to_comment: 'Bạn cần đăng nhập để thêm bình luận',
  login_required_delete: 'Bạn cần đăng nhập để xóa bình luận',
...
const enTranslations = {
  ...
  login_to_comment: 'You need to login to add a comment',
  login_required_delete: 'You need to login to delete a comment',
